...
public class OrderItemServiceImp implements OrderItemService {
    ...
    /*public int addOrderItem(Orderitem orderItem){
        int oiId = oim.insert(orderItem);
        return oiId;
    }

    public Orderitem selctOrderItemByPrimaryKey(int id){
        Orderitem orderItem = oim.selectByPrimaryKey(id);
        return orderItem;
    }

    public List<Orderitem> selctOrderItemByOid(int id){
        List<Orderitem> orderItems = oim.selectByOid(id);
        return orderItems;
    }

    public int deleteOrderItem(int id){
        int oiId = oim.deleteByPrimaryKey(id);
        return oiId;
    }*/
}
