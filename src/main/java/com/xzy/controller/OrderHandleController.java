...
import com.xzy.beans.OrderDetails;
import com.xzy.beans.OrderEst;
...
public class OrderHandleController {
    ...
    public OrderEst findAllOrderItem(){
        ...
        oe.setOrdersNumber(oNum);
        oe.setOrderitemNumber(oiNum);
        oe.setOp(allOrderitems);
        return oe;
    }

    //待支付订单
    @RequestMapping("/findPayOrderItem")
    public OrderEst findPayOrderItem(){
        List<OrderitemProduct> allOrderitems = new ArrayList<OrderitemProduct>();
    ...
    public OrderEst findSendOrderItem(){
        List<OrderitemProduct> allOrderitems = new ArrayList<OrderitemProduct>();
    ...
    public OrderEst findGetOrderItem(){
        List<OrderitemProduct> allOrderitems = new ArrayList<OrderitemProduct>();
    ...
    public OrderDetails findOneOrderItem(int orderId){
        OrderDetails orderDetails = new OrderDetails();
        Orders oneOrder = os.findOneOrder(orderId);
        orderDetails.setAddress(oneOrder.getAddressId());
        orderDetails.setTotalPri(oneOrder.getOrdersTotalPrice());
        List<OrderitemProduct> allOPByOrdId = ois.findAllOPByOrdId(orderId);
        orderDetails.setOrderitemProductList(allOPByOrdId);
        return orderDetails;
    }
